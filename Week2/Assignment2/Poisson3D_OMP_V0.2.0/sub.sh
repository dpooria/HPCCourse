...
# OMP_NUM_THREADS=16 ./poisson3d fulldata_gaussseidel.dat
...
#        ./poisson3d "gaussseidel_${thr}threads_N${N}_full_iteration.dat"
#    done
...
END
       ./poisson3d "gaussseidel_${thr}threads_N${N}.dat"       
   done
done
...
END
        ...
        ./poisson3d "gaussseidel_${thr}threads_N${N}_full_iteration_unoptimized.dat"
    done
...
# END
#         ./poisson3d "gaussseidel_${thr}threads_N${N}_unoptimized.dat"       
#     done
done
