...
PROGRAM Diffusion
   ...
   USE m_Diffusion_write, ONLY: write_to_file, output_array_to_file
   ...
   CHARACTER(LEN=*),PARAMETER :: output_file = "Diffusion_sequential_temperature.txt"
   ...
   DO k = 1, Nt
      ...
      ! ENDIF
   ENDDO
   CALL output_array_to_file(temp_new, output_file)
